...
void _categoryModelSerialize(
  ...
  writer.writeBool(offsets[3], object.sync);
...
CategoryModel _categoryModelDeserialize(
  ...
  final object = CategoryModel(
    ...
    remoteId: reader.readStringOrNull(offsets[2]),
    sync: reader.readBool(offsets[3]),
...
extension CategoryModelQueryFilter
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterFilterCondition> syncEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'sync',
...
extension CategoryModelQuerySortBy
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy> sortByPrice() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'price', Sort.asc);
    });
  }

  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy> sortByPriceDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy> sortBySync() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sync', Sort.asc);
    });
  }

  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy> sortBySyncDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryModelQuerySortThenBy
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy> thenByPrice() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'price', Sort.asc);
    });
  }

  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy> thenByPriceDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'price', Sort.desc);
    });
  }
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy> thenBySync() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sync', Sort.asc);
    });
  }

  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy> thenBySyncDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sync', Sort.desc);
    });
  }
...
extension CategoryModelQueryWhereDistinct
  ...
  QueryBuilder<CategoryModel, CategoryModel, QDistinct> distinctByPrice() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CategoryModel, CategoryModel, QDistinct> distinctBySync() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryModelQueryProperty
  ...
  QueryBuilder<CategoryModel, double, QQueryOperations> priceProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CategoryModel, bool, QQueryOperations> syncProperty() {
    return QueryBuilder.apply(this, (query) {
